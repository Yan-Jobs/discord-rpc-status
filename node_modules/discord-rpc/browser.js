    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            (function (e) {
                ...
                try {
                    const { app: t } = n(7);
                    r = t.setAsDefaultProtocolClient.bind(t);
                } catch (t) {
                    try {
                        r = n(8);
                    } catch (t) {}
        ...
        function (t, e, n) {
            ...
            (e.browser = "undefined" != typeof window),
                (e.RPCCommands = r([
                    "DISPATCH",
                    "AUTHORIZE",
                    "AUTHENTICATE",
                ...
                (e.LobbyTypes = { PRIVATE: 1, PUBLIC: 2 }),
                (e.RelationshipTypes = {
                    NONE: 0,
                    FRIEND: 1,
                    BLOCKED: 2,
        ...
        function (t, e, n) {
            "use strict";
            const r = n(0);
            t.exports = { Client: n(9), register: (t) => r.register(`discord-${t}`) };
        },
        function (t, e) {},
        function (t, e) {},
        function (t, e, n) {
            "use strict";
            const r = n(2),
                { setTimeout: i, clearTimeout: o } = n(10),
                s = n(4),
                u = n(12),
                { RPCCommands: a, RPCEvents: c, RelationshipTypes: f } = n(5),
                { pid: h, uuid: l } = n(0);
            function p(t, e) {
            ...
            t.exports = class extends r {
                constructor(t = {}) {
                    super(),
                        ...
                        (this.user = null);
                    const e = u[t.transport];
                    if (!e) throw new TypeError("RPC_INVALID_TRANSPORT", t.transport);
                    (this.fetch = (t, e, { data: n, query: r } = {}) =>
                        s(`${this.fetch.endpoint}${e}${r ? new URLSearchParams(r) : ""}`, {
                            method: t,
                            body: n,
                            ...
                            if (!t.ok) {
                                const n = new Error(t.status);
                                throw ((n.body = e), n);
                            }
                            return e;
                        })),
                        (this.fetch.endpoint = "https://discord.com/api"),
                        (this.transport = new e(this)),
                ...
                connect(t) {
                    return this._connectPromise
                        ...
                        : ((this._connectPromise = new Promise((e, n) => {
                            this.clientId = t;
                            const r = i(() => n(new Error("RPC_CONNECTION_TIMEOUT")), 1e4);
                            r.unref(),
                                this.once("connected", () => {
                                    o(r), e(this);
                                }),
                                this.transport.once("close", () => {
                                    this._expecting.forEach((t) => {
                ...
                async login(t = {}) {
                    let { clientId: e, accessToken: n } = t;
                    return (
                        await this.connect(e),
                            t.scopes
                                ? (n || (n = await this.authorize(t)), this.authenticate(n))
                ...
                request(t, e, n) {
                    return new Promise((r, i) => {
                        const o = l();
                        this.transport.send({ cmd: t, args: e, evt: n, nonce: o }),
                            this._expecting.set(o, { resolve: r, reject: i });
                    });
                }
                _onRpcMessage(t) {
                    if (t.cmd === a.DISPATCH && t.evt === c.READY)
                        t.data.user && (this.user = t.data.user), this.emit("connected");
                    else if (this._expecting.has(t.nonce)) {
                        const { resolve: e, reject: n } = this._expecting.get(t.nonce);
                        if ("ERROR" === t.evt) {
                            const e = new Error(t.data.message);
                            (e.code = t.data.code), (e.data = t.data), n(e);
                        } else e(t.data);
                        this._expecting.delete(t.nonce);
                    } else {
                        const e = p(t.evt, t.args);
                        if (!this._subscriptions.has(e)) return;
                        this._subscriptions.get(e)(t.data);
                    }
                }
                async authorize({
                                    scopes: t,
                ...
                authenticate(t) {
                    return this.request("AUTHENTICATE", { access_token: t }).then(
                        ({ application: e, user: n }) => (
                            (this.accessToken = t),
                                (this.application = e),
                                (this.user = n),
                                this.emit("ready"),
                ...
                getGuild(t, e) {
                    return this.request(a.GET_GUILD, { guild_id: t, timeout: e });
                }
                getGuilds(t) {
                    return this.request(a.GET_GUILDS, { timeout: t });
                }
                getChannel(t, e) {
                    return this.request(a.GET_CHANNEL, { channel_id: t, timeout: e });
                }
                async getChannels(t, e) {
                    const { channels: n } = await this.request(a.GET_CHANNELS, {
                        timeout: e,
                        guild_id: t,
                    });
                    return n;
                ...
                selectVoiceChannel(t, { timeout: e, force: n = !1 } = {}) {
                ...
                selectTextChannel(t, { timeout: e, force: n = !1 } = {}) {
                ...
                getVoiceSettings() {
                    return this.request(a.GET_VOICE_SETTINGS).then((t) => ({
                        automaticGainControl: t.automatic_gain_control,
                        echoCancellation: t.echo_cancellation,
                        noiseSuppression: t.noise_suppression,
                        qos: t.qos,
                        silenceWarning: t.silence_warning,
                        deaf: t.deaf,
                        mute: t.mute,
                        input: {
                            availableDevices: t.input.available_devices,
                            device: t.input.device_id,
                            volume: t.input.volume,
                        },
                        output: {
                            availableDevices: t.output.available_devices,
                            device: t.output.device_id,
                            volume: t.output.volume,
                        },
                        mode: {
                            type: t.mode.type,
                            autoThreshold: t.mode.auto_threshold,
                            threshold: t.mode.threshold,
                            shortcut: t.mode.shortcut,
                            delay: t.mode.delay,
                        },
                    }));
                }
                setVoiceSettings(t) {
                    return this.request(a.SET_VOICE_SETTINGS, {
                        ...
                        mute: t.mute,
                        input: t.input
                            ? { device_id: t.input.device, volume: t.input.volume }
                            : void 0,
                        output: t.output
                            ? { device_id: t.output.device, volume: t.output.volume }
                            : void 0,
                        mode: t.mode
                            ? {
                                mode: t.mode.type,
                                auto_threshold: t.mode.autoThreshold,
                                threshold: t.mode.threshold,
                                shortcut: t.mode.shortcut,
                                delay: t.mode.delay,
                            }
                ...
                captureShortcut(t) {
                    const e = p(c.CAPTURE_SHORTCUT_CHANGE),
                        n = () => (
                            this._subscriptions.delete(e),
                                this.request(a.CAPTURE_SHORTCUT, { action: "STOP" })
                        );
                    return (
                        this._subscriptions.set(e, ({ shortcut: e }) => {
                            t(e, n);
                        }),
                            this.request(a.CAPTURE_SHORTCUT, { action: "START" }).then(() => n)
                    );
                }
                setActivity(t = {}, e = h()) {
                    let n, r, i, o;
                    if (t.startTimestamp || t.endTimestamp) {
                        if (
                            ((n = { start: t.startTimestamp, end: t.endTimestamp }),
                            n.start instanceof Date &&
                            (n.start = Math.round(n.start.getTime())),
                    ...
                    return (
                        ...
                        (t.partySize || t.partyId || t.partyMax) &&
                        ((i = { id: t.partyId }),
                        (t.partySize || t.partyMax) &&
                        (i.size = [t.partySize, t.partyMax])),
                        (t.matchSecret || t.joinSecret || t.spectateSecret) &&
                        (o = {
                            match: t.matchSecret,
                            join: t.joinSecret,
                ...
                clearActivity(t = h()) {
                    return this.request(a.SET_ACTIVITY, { pid: t });
                }
                sendJoinInvite(t) {
                ...
                updateLobby(t, { type: e, owner: n, capacity: r, metadata: i } = {}) {
                ...
                deleteLobby(t) {
                    return this.request(a.DELETE_LOBBY, { id: t.id || t });
                }
                connectToLobby(t, e) {
                    return this.request(a.CONNECT_TO_LOBBY, { id: t, secret: e });
                }
                sendToLobby(t, e) {
                    return this.request(a.SEND_TO_LOBBY, { id: t.id || t, data: e });
                }
                disconnectFromLobby(t) {
                    return this.request(a.DISCONNECT_FROM_LOBBY, { id: t.id || t });
                }
                updateLobbyMember(t, e, n) {
                ...
                getRelationships() {
                    ...
                    return this.request(a.GET_RELATIONSHIPS).then((e) =>
                        e.relationships.map((e) => ({ ...e, type: t[e.type] }))
                    );
                }
                subscribe(t, e, n) {
                    return (
                        n || "function" != typeof e || ((n = e), (e = void 0)),
                            this.request(a.SUBSCRIBE, e, t).then(() => {
                                const r = p(t, e);
                                return (
                                    this._subscriptions.set(r, n),
                                        {
                                            unsubscribe: () =>
                                                this.request(a.UNSUBSCRIBE, e, t).then(() =>
        ...
        function (t, e, n) {
            "use strict";
            t.exports = { ipc: n(13), websocket: n(19) };
        },
        function (t, e, n) {
            "use strict";
            (function (e, r) {
                ...
                function p(t = 0) {
                    return new Promise((n, r) => {
                        const o = (function (t) {
                                if ("win32" === e.platform)
                                    return `\\\\?\\pipe\\discord-ipc-${t}`;
                                const {
                                    env: { XDG_RUNTIME_DIR: n, TMPDIR: r, TMP: i, TEMP: o },
                                } = e;
                                return `${(n || r || i || o || "/tmp").replace(
                                    /\/$/,
                                    ""
                                )}/discord-ipc-${t}`;
                            })(t),
                            s = () => {
                                t < 10 ? n(p(t + 1)) : r(new Error("Could not connect"));
                            },
                            u = i.createConnection(o, () => {
                                u.removeListener("error", s), n(u);
                            });
                        u.once("error", s);
                    });
                }
                function d(t, e) {
                    e = JSON.stringify(e);
                    const n = r.byteLength(e),
                        i = r.alloc(8 + n);
                    return (
                        i.writeInt32LE(t, 0), i.writeInt32LE(n, 4), i.write(e, 8, n), i
                    );
                }
                const E = { full: "", op: void 0 };
                function _(t, e) {
                    const n = t.read();
                    if (!n) return;
                    let r,
                        { op: i } = E;
                    if ("" === E.full) {
                        i = E.op = n.readInt32LE(0);
                        const t = n.readInt32LE(4);
                        r = n.slice(8, t + 8);
                    } else r = n.toString();
                    try {
                        e({ op: i, data: JSON.parse(E.full + r) }),
                            (E.full = ""),
                            (E.op = void 0);
                    } catch (t) {
                        E.full += r;
                ...
                (t.exports = class extends o {
                    constructor(t) {
                        super(), (this.client = t), (this.socket = null);
                    }
                    async connect() {
                        const t = (this.socket = await p());
                        t.on("close", this.onClose.bind(this)),
                            t.on("error", this.onClose.bind(this)),
                            this.emit("open"),
                            t.write(d(a, { v: 1, client_id: this.client.clientId })),
                            t.pause(),
                            t.on("readable", () => {
                                _(t, ({ op: t, data: e }) => {
                                    switch (t) {
                                        ...
                                        case c:
                                            ...
                                            (async function t(e = 0) {
                                                ...
                                                const n = `http://127.0.0.1:${6463 + (e % 10)}`;
                                                try {
                                                    return 404 === (await s(n)).status ? n : t(e + 1);
                                                } catch (n) {
                                                    return t(e + 1);
                                                }
                                            })().then((t) => {
                                                this.client.request.endpoint = t;
                                            }),
                                                this.emit("message", e);
                                            break;
                                        case f:
                    ...
                    send(t, e = c) {
                        this.socket.write(d(e, t));
                    }
                    close() {
                        this.send({}, f), this.socket.end();
                    }
                    ping() {
                        this.send(u(), h);
                    }
                    ...
                    for (
                        e = Math.abs(e),
                            isNaN(e) || e === 1 / 0
                                ...
                                (e += s + h >= 1 ? l / a : l * Math.pow(2, 1 - h)) * a >= 2 &&
                                (s++, (a /= 2)),
                                    s + h >= f
                                        ? ((u = 0), (s = f))
                                        : s + h >= 1
        ...
        function (t, e, n) {
            ...
            const r = n(2),
                { browser: i } = n(5),
                o = i ? window.WebSocket : n(20);
            t.exports = class extends r {
                constructor(t) {
                    super(), (this.client = t), (this.ws = null), (this.tries = 0);
                }
                async connect(t = this.tries) {
                    if (this.connected) return;
                    const e = 6463 + (t % 10);
                    this.hostAndPort = `127.0.0.1:${e}`;
                    const n = (this.ws = new o(
                        `ws://${this.hostAndPort}/?v=1&client_id=${this.client.clientId}`,
                        { origin: this.client.options.origin }
                    ));
                    (n.onopen = this.onOpen.bind(this)),
                        (n.onclose = n.onerror = this.onClose.bind(this)),
                        (n.onmessage = this.onMessage.bind(this));
                }
                send(t) {
                    var e;
                    this.ws && this.ws.send(((e = t), JSON.stringify(e)));
                }
                close() {
                ...
                onMessage(t) {
                    var e;
                    this.emit("message", ((e = t.data), JSON.parse(e)));
                }
                onOpen() {
                    this.emit("open");
                }
                onClose(t) {
                    ...
                    const e = t.code >= 4e3 && t.code < 5e3;
                    (t.code && !e) || this.emit("close", t),
                    e ||
                    setTimeout(
                        () => this.connect(1006 === t.code ? ++this.tries : 0),
                        250
                    );
                }
            };
